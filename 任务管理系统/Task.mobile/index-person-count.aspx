<%@ Page Title="任务管理系统" Language="C#" MasterPageFile="~/master/main-drawer.master" AutoEventWireup="true" CodeFile="index-person-count.aspx.cs" Inherits="index_person" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        ...
        $(".content_box>ul>li").eq(2).addClass("active");
