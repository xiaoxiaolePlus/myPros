<%@ Page Title="任务管理系统" Language="C#" MasterPageFile="~/master/main-drawer.master" AutoEventWireup="true" CodeFile="index-person-setting.aspx.cs" Inherits="index_person" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li role="presentation">
                        ...
                        <div id="third">
                            <div class="person_zl">
                                <p>个人资料：</p>
                                <p>您可以设置谁可以查看您的个人信息</p>
                                <button>权限设置</button>
                            </div>
                            <div class="task_tx">
                                <p>任务提醒：</p>
                                <p><input type="checkbox" />登录后显示未完成或未接受任务信息</p>
                            </div>
                            <div class="person_zt">
                                <p>个人状态：</p>
                                <p>
                                    <input type="checkbox" />我的登录状态<br />
                                    <input type="checkbox" />我的地理位置与天气<br />
                                </p>
                            </div>
                        </div>
                    </li>
    ...
    <script>
        ...
        $(".content_box>ul>li").eq(3).addClass("active");
