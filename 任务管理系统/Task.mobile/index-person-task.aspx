<%@ Page Title="任务管理系统" Language="C#" MasterPageFile="~/master/main-drawer.master" AutoEventWireup="true" CodeFile="index-person-task.aspx.cs" Inherits="index_person" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="content_box">
                <ul class="nav nav-pills nav-stacked">
                    <li role="presentation" class="active">
                        <a href="index-person-infomation.aspx">
                        ...
                        <div id="first">
                            <div class="firstNav">
                                <div class="row rows-two">
                                    <div class="btn-group btn-group-justified" style="width:90%;margin:0 auto">
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu uls">
                                                <li ng-click="AllTask()"><a href="javascript:void(0)">全部</a></li>
                                                <li ng-click="todayAllTask()"><a href="javascript:void(0)">今天</a></li>
                                                <li ng-click="threeAllTask()"><a href="javascript:void(0)">近三天</a></li>
                                            </ul>
                                        </div>
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu uls">
                                                <li ng-click="finshedAllTask()"><a href="javascript:void(0)">全部</a></li>
                                                <li ng-click="finshedTodayTask()"><a href="javascript:void(0)">今天</a></li>
                                                <li ng-click="finshedThreeTask()"><a href="javascript:void(0)">近三天</a></li>
                                            </ul>
                                        </div>
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu uls">
                                                <li ng-click="unfinshedAllTask()"><a href="javascript:void(0)">全部</a></li>
                                                <li ng-click="unfinshedTodayTask()"><a href="javascript:void(0)">今天</a></li>
                                                <li ng-click="unfinshedThreeTask()"><a href="javascript:void(0)">近三天</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>                
                                <div class="search_box form-group has-feedback" style="margin:10px auto;width:100%">
                                    <input type="text" class="form-control" placeholder="Search">
                                    <span class="form-control-feedback glyphicon glyphicon-search"></span>
                                </div>
                            </div>
                            <div class="task" ng-repeat="data in datas">
                                <set-id class="{{data.ID}}">

                                </set-id>  
                                <div class="task_text">
                                    <a href="javascript:void(0)"><img src="../assets/images/user.png" alt="Alternate Text" /></a>
                                    <div class="task_text_center">
                                        <p class="p_name">{{data.ServerName}}</p>
                                        <p class="p_title">{{data.CommandContent}}</p>
                                        <p style="color:red;">{{data.Description}}</p>
                                    </div>
                                    <div class="task_text_right">
                                        <p>发布时间:<span>{{data.CreateTime}}</span></p>
                                        <p>完成日期:<span style="color:red;">{{data.DisableTime}}</span></p>
                                    </div>
                                </div>
                            </div>
                            <button class="btn btn-default" style="margin-top:20px; width:30%;margin-left:35%">加载更多...</button>
                        </div>
                    </li>
                    <li role="presentation">
    ...
    <script>
        ...
        $(".content_box>ul>li").eq(1).addClass("active");
        $(".content_box>ul>li").eq(0).removeClass("active");
