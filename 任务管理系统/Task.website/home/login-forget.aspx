            ...
            <div class="maincenter">
                <div class="maincenter-box">
                    ...
                    <div class="ui-form-item one">
                        ...
                        <input  class="ui-input" name="logonId" placeholder="请输入用户名" id="user"  value=""  type="text">
                        <a  class="ui-form-other" href=""  >忘记账户名？</a>
                    </div>
                    <p class="p3"></p>
                    <div class="ui-form-item">
                        <label class="ui-label">邮箱</label>
                        <input  class="ui-input" id="email" name="logonId" placeholder="电子邮箱或手机号码"  value=""  type="text">
                    </div>
                    <div class="ui-form-item">
                        <label class="ui-label">验证码</label>
                        <input  class="ui-input ui-input-checkcode yzm" name="picCheckCode"  type="text">
                        <button class="btn access_yzm" href="#">获取验证码</button>
                    </div>
                    <p class="p3"></p>
                    <div class="ui-form-item ui-form-item-last">
                        <div class="ui-button ui-button-morange">
                            <input class="ui-button-text" id="next" value="下一步" type="submit">
                        </div>
                    </div>
                </div>
            </div>
